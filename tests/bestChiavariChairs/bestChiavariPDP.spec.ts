...
test.skip('BestChiavariPDP', async ({ page }) => {
    ...
    //Click Review Stars    
        const ReviewStars = page.locator("//div[@class='bv_stars_component_container']");
        await ReviewStars.click();
    //Click New Review
        const NewReview = page.locator("div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(5) > div:nth-child(1)");
        await NewReview.click();
        const CloseReview = page.locator("svg[xmlns='http://www.w3.org/2000/svg'][width='21']");
